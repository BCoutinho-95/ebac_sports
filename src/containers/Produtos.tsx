...
import { Produto as ProdutoType } from '../components/Produto/styles'
...
const Produtos = () => {
  ...
  const adicionarAoCarrinhoHandler = (produto: typeof ProdutoType) => {
    dispatch(adicionarAoCarrinho(produto))
  }

  const favoritarHandler = (produto: typeof ProdutoType) => {
    dispatch(favoritar(produto))
  }

  const produtoEstaNosFavoritos = (produto: typeof ProdutoType) => {
